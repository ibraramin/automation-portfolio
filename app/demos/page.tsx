...
export const metadata: Metadata = {
  ...
  description:
    "Six live interactive demos: WhatsApp order bot, AI invoice reader, lightning lead response, meeting minutes bot, spreadsheet rescue and email triage. Download the n8n workflows for free.",
};
