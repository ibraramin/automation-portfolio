...
function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      />
      <div
        className="animate-glow-drift pointer-events-none absolute -top-40 -left-40 h-[30rem] w-[30rem] rounded-full bg-[radial-gradient(circle_at_35%_35%,rgba(14,116,144,0.12),transparent_60%)] bg-[length:180%_180%] blur-[130px] [will-change:transform]"
        aria-hidden="true"
      />
      <div
      ...
      <div className="container-site grid gap-14 pt-20 pb-20 md:pt-28 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-16 lg:pb-28">
        <div>
          ...
          >
            ...
            <span className="bg-linear-to-r from-accent to-sky bg-clip-text text-transparent">
          ...
          >
            ...
            Chat with RAG inference + bookings/reminders + FB comment → DM, not a lead-hunting
            agency — for SMBs that already have customers and want to automate the tedious parts.
          </p>
          <div
