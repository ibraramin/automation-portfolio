      ...
      <div className="mx-auto w-full max-w-6xl px-5 py-14 sm:px-8">
        <div className="grid gap-10 md:grid-cols-3">
          <div>
            ...
            <p className="mt-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.18em] text-muted">
              <Icon name="map-pin" className="h-3.5 w-3.5 text-wa" />
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-muted">
              ...
              <li className="inline-flex items-center gap-2">
                ...
                Live during European business hours
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-3 border-t border-white/10 pt-6 text-xs text-muted sm:flex-row sm:items-center">
          <p>
            © {new Date().getFullYear()} {SITE.name}. Built in Dhaka, delivered worldwide.
          </p>
